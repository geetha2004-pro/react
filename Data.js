  ...
  },
  {
      ...
      title: "50% Off For Your First Shopping",
      desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis lobortis consequat eu, quam etiam at quis ut convallis.",
      cover:require('../images/phone-01.jpg') ,
  },
  {
      id: 3,
      title: "50% Off For Your First Shopping",
...
export const serviceData = [
  {
    icon:  <i class="fa-solid fa-car fa-2xl"></i>,
    title: "Free Shipping",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#fdefe6",
  },
  {
    icon: <i class="fa-solid fa-credit-card fa-2xl"></i>,
    title: "Safe Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#ceebe9",
  },
  {
    icon:<i class="fa-solid fa-shield-halved fa-2xl"></i>,
    title: "Secure Payment",
    subtitle: "Lorem ipsum dolor sit amet.",
    bg: "#e2f2b2",
  },
  {
    icon: <i class="fa-solid fa-headphones fa-2xl"></i>,
